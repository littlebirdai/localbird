          ...
          <div className="space-y-0.5">
            {chats.map((chat) => (
              <button
                ...
                className={cn(
                  'w-full group flex items-start gap-2.5 rounded-md px-2.5 py-2 text-left transition-all duration-150',
                  currentChatId === chat.id
                    ? 'bg-muted/80 text-foreground'
                    : 'text-muted-foreground hover:bg-muted/40 hover:text-foreground'
                )}
              >
                <MessageSquareIcon className="w-4 h-4 mt-0.5 flex-shrink-0 opacity-50" />
                ...
                <button
                  ...
                  className="opacity-0 group-hover:opacity-60 hover:!opacity-100 p-1 hover:bg-destructive/10 rounded transition-all"
                >
